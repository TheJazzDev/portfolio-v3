...
// @ts-nocheck 
/*
 * This file exports the `ProjectView` model and its related types.
 *
...
export type GetProjectViewAggregateType<T extends ProjectViewAggregateArgs> = {
    ...
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateProjectView[P]>
    : Prisma.GetScalarType<T[P], AggregateProjectView[P]>
}
...
type GetProjectViewGroupByPayload<T extends ProjectViewGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<ProjectViewGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof ProjectViewGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], ProjectViewGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], ProjectViewGroupByOutputType[P]>
      }
    >
  >
...
export type ProjectViewWhereInput = {
  ...
  projectTitle?: Prisma.StringFilter<"ProjectView"> | string
  timestamp?: Prisma.DateTimeFilter<"ProjectView"> | Date | string
}
...
export type ProjectViewScalarWhereWithAggregatesInput = {
  ...
  projectTitle?: Prisma.StringWithAggregatesFilter<"ProjectView"> | string
  timestamp?: Prisma.DateTimeWithAggregatesFilter<"ProjectView"> | Date | string
}
...
export type ProjectViewOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "projectId" | "projectTitle" | "timestamp", ExtArgs["result"]["projectView"]>
...
export type ProjectViewCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
...
export interface ProjectViewDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  ...
  **/
  count<T extends ProjectViewCountArgs>(
    args?: Prisma.Subset<T, ProjectViewCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], ProjectViewCountAggregateOutputType>
      : number
  >
  ...
  **/
  ...
  >(args: Prisma.SubsetIntersection<T, ProjectViewGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetProjectViewGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
...
export interface ProjectViewFieldRefs {
  ...
  readonly projectTitle: Prisma.FieldRef<"ProjectView", 'String'>
  readonly timestamp: Prisma.FieldRef<"ProjectView", 'DateTime'>
}
