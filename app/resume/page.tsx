      ...
      <div className="max-w-5xl mx-auto bg-white rounded-lg shadow-xl p-6 sm:p-8 md:p-10 print:shadow-none print:rounded-none print-ready">
        ...
        <div className="text-center mb-4 pb-4 border-b-2 border-gray-800">
          ...
          <div className="text-sm text-gray-600 mb-4">
            LEAD FRONTEND ENGINEER | REACT.JS • NEXT.JS • TYPESCRIPT
            SPECIALIST
          </div>
        ...
        <div className="mb-6">
          ...
          <p className="text-xs text-gray-700 mb-4 print:mb-2 leading-relaxed text-justify">
            ...
            experience architecting and scaling web applications across
            fintech, Web3, food delivery, and healthcare sectors. Proven expertise in
            ...
            pixel-perfect, performance-optimized applications serving
            thousands of users.
          </p>
        ...
        <div className="mb-6">
          ...
          <div className="space-y-2 print:space-y-1 text-xs text-gray-700">
            <div>
              ...
              React.js • Next.js • TypeScript • JavaScript (ES6+) • React
              Native • Flutter • TailwindCSS • GSAP • Shadcn UI
            </div>
            <div>
            ...
            <div>
              <strong className="underline">Leadership:</strong> Team
              Leadership • Mentorship • Code Review • Technical Documentation
              • Agile (Scrum/Kanban)
            </div>
            <div>
        ...
        <div className="mb-6">
          ...
          <div className="mb-4">
            ...
            <p className="text-xs text-gray-600 mt-2">
              <strong>Skills:</strong> Next.js | React.js | TypeScript | Firebase | Stripe API | DPD API | Zustand | API Development
            </p>
          </div>
          ...
          <div className="mb-4">
            ...
            <ul className="text-xs text-gray-700 space-y-2 print:space-y-0 ml-4 list-disc">
              <li>
                Leading a high-performing team of 4 frontend developers
                building scalable accounting software using micro-frontend
                architecture and 300+ integrated API endpoints
              </li>
              <div className="page-break"></div>
              <li>
                Architected and implemented micro-frontend architecture
                enabling independent team workflows and seamless integration
                across services
              </li>
              <li>
              ...
              <li>
                Optimized applications for performance, identifying
                bottlenecks and reducing load times through profiling and code
                analysis
              </li>
            </ul>
            <p className="text-xs text-gray-600 mt-2">
          ...
          <div className="mb-4">
            ...
            <p className="text-xs text-gray-600 mb-2">
              Next-generation decentralized exchange (DEX) built on the
              Arbitrum network (Web3)
            </p>
            <ul className="text-xs text-gray-700 space-y-2 print:space-y-0 ml-4 list-disc">
              <li>
                Collaborated with design team to create intuitive,
                user-friendly frontend for blockchain DApp
              </li>
              <li>
              ...
              <li>
                Optimized web architecture for scalability resulting in
          ...
          <div className="mb-4">
            ...
            <p className="text-xs text-gray-600 mb-2">
              Forex brand helping traders and investors achieve profitability
              in forex markets
            </p>
            <ul className="text-xs text-gray-700 space-y-2 print:space-y-0 ml-4 list-disc">
              <li>
                Designed and developed fully responsive multi-page Forex
                website with seamless UX
              </li>
              <li>
              ...
              <li>
                Integrated REST APIs with Myfxbook to fetch real-time
                financial data
              </li>
            </ul>
          </div>
          ...
          <div className="mb-4">
            ...
            <ul className="text-xs text-gray-700 space-y-2 print:space-y-0 ml-4 list-disc">
              <li>
                ...
                successfully launch 5 products
              </li>
              <li>
              ...
              <li>
                Made codebase 100% developer-friendly through comprehensive
                code reviews and documentation
              </li>
              <li>
                Provided mentorship and technical guidance to junior
                developers, improving team efficiency
              </li>
            </ul>
            <p className="text-xs text-gray-600 mt-2">
        ...
        <div className="mb-6">
          ...
          <ul className="text-xs text-gray-700 space-y-2 ml-4">
            ...
            <li>
              ✓ Evaluated 20,000+ lines of code, improving product
              optimization by 20%
            </li>
            <li>
            ...
            <li>
              ✓ Designed micro-frontend architecture enabling scalable
              workflows and 300+ API integrations
            </li>
            <li>
              ✓ Successfully led cross-functional teams of 8+ people to
        ...
        <div>
          ...
          <div className="space-y-1 text-xs text-gray-700">
            ...
            <div>
              <strong>Interests:</strong> Coding & Software Architecture |
              Team Leadership & Mentorship | Web3 & Blockchain Development
            </div>
          </div>
        </div>
      </div>
