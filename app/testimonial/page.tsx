      ...
      <div className='max-w-3xl mx-auto'>
        ...
        <div className='mb-8 md:mb-10'>
          ...
          <p className='text-sm md:text-base text-gray-400 leading-relaxed'>
            ...
            testimonial will be reviewed and may be featured on my portfolio.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className='space-y-4 md:space-y-5'>
          ...
          {submitStatus === 'success' && (
            <div className='flex items-center gap-2 text-neon-500 text-sm md:text-base p-3 md:p-4 bg-neon-500/10 border border-neon-500/30 card-rounded'>
              ...
              <span>
                ...
                and will be visible on the portfolio once approved.
              </span>
            </div>
          )}
          ...
          {submitStatus === 'error' && (
            <div className='flex items-center gap-2 text-red-500 text-sm md:text-base p-3 md:p-4 bg-red-500/10 border border-red-500/30 card-rounded'>
              ...
              <span>
                Failed to submit testimonial. Please try again or contact me
                directly.
              </span>
            </div>
          )}
        ...
        <div className='mt-8 md:mt-10 p-4 md:p-5 bg-white/5 border border-white/20 card-rounded'>
          <p className='text-xs md:text-sm text-gray-400 leading-relaxed'>
            ...
            testimonials are reviewed before being published. I reserve the
            right to edit testimonials for length and clarity while maintaining
            the original meaning. By submitting this form, you consent to your
            testimonial being displayed publicly on this portfolio.
          </p>
        </div>
      </div>
    </main>
